...
{ 
   ...
   function Write-Log
    ...
    return "'$computerName' computer is member of domain '$nameoftheDomain'"
    }else
    {
    ...
    return "'$computerName' computer is member of '$nameoftheDomain'"
    }
    }
    ...
    Node localhost
    {
        ...
        Log domainValidation {
        DependsOn = "[xComputer]DomainJoin"
        Message = Write-Log -Message memberofDomain
