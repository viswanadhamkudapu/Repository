...
$VMName = (Get-WmiObject win32_computersystem).DNSHostName
start-job -ScriptBlock{
param($SubscriptionId,$Username,$Password,$VMName,$resourceGroupName)

PowerShell -NoProfile -ExecutionPolicy Bypass -Command "& 'C:\PSModules\RemoveRG.ps1' -SubscriptionId $SubscriptionId -Username $Username -Password $Password -VMName $VMName -resourceGroupName $resourceGroupName"

} -ArgumentList($SubscriptionId,$Username,$Password,$VMName,$resourceGroupName)